...
class SceneClipboard():
    ...
    def serializeSelected(self, delete=False):
        ...
        # remove edges not connected to out list ofnodes
        edges_to_remove = []
        for edge in sel_edges:
            ...
            if not (edge.start_socket.id in sel_sockets and edge.end_socket.id in sel_sockets):
                if DEBUG: print("edge", edge, "is not connected with both sides")
                edges_to_remove.append(edge)
    ...
    def deserializeFromClipboard(self, data):
        ...
        # calcualte seleted objects bbox and center
        ...
        for node_data in data['nodes']:
            ...
            new_node.deserialize(node_data, hasmap, restore_id=False)
            pos = new_node.pos
        ...
        if 'edges' in data:
            for edge_data in data['edges']:
                ...
                new_edge.deserialize(edge_data, hasmap, restore_id=False)
